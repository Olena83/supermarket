...
public class Message {
    ...
    public static String assortments_quantity ="  грн вартість покупки.";
    public static String error = "Невірно введена кількість,спробуйте знов! ";
    ...
    public static String order = " Дякую що завітали в наш супермаркет. Вам потрібно заплатити - ";
    public static String good_day = ". До побачення и гарного дня!";
